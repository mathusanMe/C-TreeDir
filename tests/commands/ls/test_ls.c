...
bool test_path_to_file(FILE *output, bool verbose)
{
    ...
    display_test(is_valid, "test_path_to_file", output);
    return is_valid;
}
...
bool test_path_to_empty_directory(FILE *output, bool verbose)
{
    ...
    bool is_valid = ls(root, path, output, verbose);
    display_test(is_valid, "test_path_to_empty_directory", output);
    return is_valid;
}
...
bool test_path_to_directory_with_files(FILE *output, bool verbose)
{
    ...
    char *path = "Td";
    bool is_valid = ls(root, path, output, verbose);
    display_test(is_valid, "test_path_to_directory_with_files", output);
    return is_valid;
}
